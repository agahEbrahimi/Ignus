...
class Modifier : public Statement {
    public:
        vector<int> mods; 
        Modifier(){}
};
...
class MethodStatement : public BaseStatement {};

class MethodDecl : public MethodStatement {
    public:
        Block& block;
        const Identifier& type; 
        Identifier& id; 
        Modifier mod;
        DeclGroup arguments;
        MethodDecl(Block& block, const Identifier& type, Identifier& id, DeclGroup arguments) : block(block), id(id), type(type), arguments(arguments) {}
        MethodDecl(Modifier mod, Block& block, const Identifier& type, Identifier& id, DeclGroup arguments) : mod(mod), block(block), id(id), type(type), arguments(arguments) {}
};

class EmpMethodDecl: public MethodStatement {
    public:
        Block& block;
        const Identifier& type; 
        Identifier& id; 
        ...
        EmpMethodDecl(Block& block, const Identifier& type, Identifier& id) : block(block), id(id), type(type) {}
        EmpMethodDecl(Modifier mod, Block& block, const Identifier& type, Identifier& id) : mod(mod), block(block), id(id), type(type) {}
