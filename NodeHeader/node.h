...
class Program : public Node{
    public:
        ...
        Program(ProgramBlock programBlock) : programBlock(programBlock) {}
};
...
class ControlStatements : public Control {
    public: 
        ...
        int type;
        Block& block; 
        ControlStatements(Expression& condition, int type, Block& block) : condition(condition), type(type), block(block) {} 
...
class ControlLoop : public Control {
    public: 
        ...
        Block& block; 
        Expression& postAct;
        ControlLoop(int type, Statement& preCond, Expression& condition, Block& block, Expression& postAct) : preCond(preCond), postAct(postAct), condition(condition), type(type), block(block) {} 
...
class SecControlStatements : public Control {
    public: 
        ...
        Block& block; 
        Control& proceeding;
        SecControlStatements(Expression& condition, int type, Block& block, Control& proceeding) : condition(condition), type(type), block(block), proceeding(proceeding) {} 
};
